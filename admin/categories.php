...
<style>
	...
	body {
		background-image: none !important; /* Remove any background image globally */
		background-color: #fff; /* Ensure solid background color if needed */
	}

	/* Reset background for any other elements that might be affected */
	.container-fluid, .col-lg-12, .card {
